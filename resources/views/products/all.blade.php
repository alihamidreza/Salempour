            ...
            <div class="container" style="z-index: 1">
                <div class="col-md-6 col-sm-6 col-xs-12 col-lg-4" style="margin-top:15px;">
                    <div class="card mb-2">
                        ...
                        <a href="{{ route('products.single' , $product->slug) }}" class="imageStyle"> <img
                                    class="card-img-top " src="{{ $product->images['images']['321'] }}"
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="{{ route('products.single' , $product->slug) }}">مشاهده
                                محصول</a>
                        </div>
                    </div>
                </div>
