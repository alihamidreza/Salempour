...
@section('content')
    <div class="backheader">
        <header>
            ...
            <div class="view jarallax" data-jarallax='{"speed": 0.2}'
                 style="background-image: url('images/photo_2016-05-29_21-08-50 (1).jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;background-attachment: fixed">
                    ...
                    <div class="container">
                        ...
                        <div class="" style="width: 100%;">
                            ...
                            <div class="col-md-12 white-text text-center">
                                <h1 class="display-3 mb-0 pt-md-5 pt-5 white-text font-weight-normal wow animated bounceInRight logo-text"
                                    data-wow-delay="0.3s">
                                    <a class="indigo-text font-weight-normal peach-gradient"
                                       style="color: #d32f2f !important" href="/">
                                        پیشگام کامپوزیت</a>
                                    اروند
                                </h1>
                                <h5 class="text-uppercase pt-md-5 pt-sm-2 pt-5 pb-md-5 pb-sm-3 pb-5 white-text font-weight-bold wow animated bounceInLeft"
            ...
            <!-- Full Page Intro -->
            <div class="arrow-down animated bounce infinite"
                 style="width: 100%;bottom: 0;position: absolute;text-align: center">
                <span class="fa fa-angle-down arrow-down-site" id="scrolldown" style="font-size:70px;color:white;cursor: pointer;"></span>
            </div>
        </header>
    </div>
    <!-- Main navigation -->
    ...
    <!-- Section: Blog v.1 -->
    <section class="my" style="widows: 100%;;" id="ifscrolled">
        <!--Carousel Wrapper-->
        <div id="multi-item-example" class="carousel slide carousel-multi-item container" data-ride="carousel">
            <div data-aos="fade-up"
                ...
                <center>
                    <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 90px;height: 1px;">
                </center>
                <!-- Section description -->
            </div>
            <a class="btn btn-red" style="background: #d32f2f!important;margin-left:10px; "
               href="{{ route('articles.index') }}">مشاهده همه</a>
            <br>
            <br>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card mb-2">
                                    ...
                                    <a href="{{ route('articles.single' , ['article' => $article->slug]) }}"
                                       class="imageStyle img-fluid"> <img class="card-img-top "
                                                                src="{{ $article->images['images']['321'] }}"
                                                                alt="{{ $article->title }}" height="241"></a>
                                    <div class="card-body">
                                        <span class="writer"
                                              style="z-index: 1000">نویسنده: {{ $article->writer }}</span>
    ...
    <section class="my-5 container">
        ...
        <a class="btn btn-red" style="background: #d32f2f!important;" href="{{ route('products.index') }}">مشاهده
            همه</a>
        <br>
        <br><br>
            ...
            <div class="row" data-aos="fade-left"
                ...
                <div class="col-lg-5 col-xl-4">
                    ...
                    <div class="view overlay rounded z-depth-1-half mb-lg-0 mb-4" style="width: 321px !important;">
                        <a href="{{ route('products.single' , $product->slug) }}"> <img class="card-img-top "
                                                                                        src="{{ $product->images['images']['321'] }}"
                                                                                        alt="{{ $product->title }}"
                                                                                        height="241"></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="card testimonial-card backAdmin">
                    ...
                    <!--Avatar-->
                    <!-- Section heading -->
                    <h2 class="h1-responsive font-weight-bold text-center my-5" style="color: white;">درباره
                        مدیرعامل</h2>
                    <center>
                        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto"
                            style="width: 90px;height: 1px;" style="background-color: white !important">
                    </center>
                    <!-- Section description -->
                    <div class="avatar mx-auto white" style="border-radius: 50% !important">
                        <img src="images/download.png" class="rounded-circle img-fluid"
                             style="border-radius: 50% !important;position: relative;z-index: none;">
                    </div>
                    <div class="card-body">
                        <!--Name-->
                        ...
                        <hr>
                        <!--Quotation-->
                        <p class="dark-grey-text mt-4"><i class="fa fa-quote-left pr-2"></i>ستون و سطرآنچنان که لازم است
    ...
    <section class="my-5 container">
        ...
        <center>
            <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto"
                style="width: 90px;height: 1px;background: #d32f2f !important;">
        </center>
        <!-- Section description -->
        <!-- Grid row -->
        <div class="row">
